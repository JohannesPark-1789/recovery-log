...
- **Phase** · 8단계 회복 타임라인 (현재 phase 자동 하이라이트 + 진행률 / 지나간 phase DONE 표시), **수술 세부항목 보기** (200+ 항목, 6개 그룹: 수술·마취·입원·약물·검사·보조기, 검색·필터·금액 표시), 수술부 사진 (D별 정렬 + **Compare 모드** 로 두 시점 side-by-side 비교) / X-ray / 진단서 기록, Fraunces serif 저널 (사진 첨부 가능)
...
- **Search** · 헤더 우상단 🔍 → 저널·통증·약·문서·X-ray·비용·수술항목·용어집·vitals 전체 통합 검색, 결과 클릭 시 해당 탭으로 이동 + 항목 하이라이트
