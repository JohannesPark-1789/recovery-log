...
sources = [
    {
        ...
        'cost': {
            ...
            'vendor': '***병원',
            'amount': 59890,
            'note': '총진료비 ₩87,634 / 본인부담 ₩59,890 (카드 일시불, ****, 승인 ***). 영수증번호 ***.'
        }
    },
    {
        'pdf': '조제약복약안내.pdf',
        'cost': {
            ...
            'vendor': '가온약국',
            'amount': 3000,
            'note': '약제비 총액 ₩10,000 / 본인부담 ₩3,000 (현금영수증). 영수증번호 ***. 투약일수 2일 · 1일 3회 식후30분.'
        }
    },
    {
        ...
        'cost': {
            ...
            'note': '진료기간 ****-**-** ~ 05-15. 총진료비 ₩5,484,254 (급여 본인 1,032,937 + 공단 2,730,120 + 선택진료 87,297 + 비급여 1,633,900) / 본인부담 ₩2,754,090 (카드 일시불, ****, 승인 ***). 영수증번호 ***. 세부산정내역서 별첨.'
        }
    },
    {
        ...
        'cost': {
            ...
            'vendor': '***병원',
            'amount': 23000,
            'note': '총진료비 ₩23,000 (전액 기타 비급여) / 본인부담 ₩23,000 (카드 일시불, ****, 승인 ***). 영수증번호 ***.'
        }
    },
]
...
js = f'''(() => {{
  ...
  for (const e of incoming) {{
    ...
    const surgery = (state.profile && state.profile.date) || '****-**-**';
