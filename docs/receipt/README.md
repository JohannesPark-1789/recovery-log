...
| 파일 | 날짜 | 유형 | 본인부담 |
|---|---|---|---|
| `외래_진료비계산서영수증.pdf` | ****-**-** | 외래 진료비 | ₩59,890 |
| `조제약복약안내.pdf` | ****-**-** | 약값 (가온약국) | ₩3,000 |
| `입원_퇴원_진료비계산서영수증.pdf` | ****-**-** | 입원 4박5일 (병실 312) | ₩2,754,090 |
| `입원_중간_진료비계산서영수증.pdf` | ****-**-** | 입원 중간정산 (비급여) | ₩23,000 |
| `진료비세부산정내역.pdf` | ****-**-** | 입원 진료 세부 명세서 (참고용, 결제 아님) | — |
| **합계 본인부담** | | | **₩2,839,980** |
